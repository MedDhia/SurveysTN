...
**434 variables across 26 of the 36 surveys.**
...
|---|---:|---:|---|
| Economic gap and redistribution | 46 | 24 | AB, AOI, Afro, ArabTrans, LiTS, SAHWA, WVS |
| Gender inequality | 63 | 14 | AB, AOI, Afro, ArabTrans, SAHWA, WVS |
| Discrimination and unfair treatment | 84 | 11 | AB, AOI, Afro, LiTS |
| Wasta and access through connections | 8 | 7 | AB, ArabTrans |
...
70 of these questions recur, which is where a series over time
...
70 that recur at all — so nearly every series here has to be built
inside one programme. The exceptions are worth knowing by name:

| Question | Surveys | Series |
|---|---:|---:|
| Women should have equal inheritance rights | 2 | 2 |
