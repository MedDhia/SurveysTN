...
survey is one self-describing folder: the respondents, in four formats, with a
...
| Arab Barometer Wave V | 2,400 | 359 (282 with data) | 2018–2019 | [`data/arab-barometer/wave-05`](data/arab-barometer/wave-05) |
| Arab Barometer Wave VIII | 2,406 | 690 (466 with data) | Sep–Nov 2023 | [`data/arab-barometer/wave-08`](data/arab-barometer/wave-08) |

6,002 Tunisian respondents. `catalog/catalog.csv` and `catalog/catalog.json` carry
...
All four data files hold identical values. Start with
[`docs/using-the-data.md`](docs/using-the-data.md) — in particular the four things
...
four formats. Nothing is recoded, rescaled, imputed or renamed. Every generated
